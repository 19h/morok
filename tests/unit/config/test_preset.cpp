...
TEST_CASE("high preset matches the documented table") {
    ...
    CHECK(c.self_checksum.probability == 35u);
    CHECK(c.self_checksum.max_constants == 8u);
    CHECK(c.self_checksum.region_bytes == 32u);
    CHECK(c.data_flow_integrity.enabled == true);
    CHECK(c.data_flow_integrity.probability == 35u);
    CHECK(c.data_flow_integrity.max_tables == 2u);
    CHECK(c.data_flow_integrity.region_bytes == 32u);
    CHECK(c.mutual_guard.enabled == true);
    CHECK(c.mutual_guard.probability == 35u);
